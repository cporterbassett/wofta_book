...
ENTRIES = [
    ...
    ("Faded Love", "pdf", os.path.join(PDF_DIR, "Faded Love D & A.pdf"), {}),
    ("Flop Eared Mule", "abc", os.path.join(ABC_DIR, "Flop Eared Mule-verified.abc"), {}),
    ("Back Home Again in Indiana", "pdf", os.path.join(PDF_DIR, "Back Home Again in Indiana.pdf"), {}),
    ...
    ("Gum Tree Canoe", "odt", os.path.join(ODT_DIR, "Gumtree Canoe_G.odt"), {"pages": [0]}),
    ...
    ("Roll in My Sweet Baby's Arms", "text_2col", os.path.join(TXT_DIR, "Roll in My Sweet Babys Arms - lyrics chords.txt"), {"key_note": "Key: G"}),
    ...
    ("Rose in the Mountain", "pdf", os.path.join(PDF_DIR, "Rose in the Mountain.pdf"), {}),
    ("Sugar Moon", "pdf", os.path.join(PDF_DIR, "Sugar Moon.pdf"), {}),
    ("Drunken Sailor", "odt", os.path.join(ODT_DIR, "drunken sailor.odt"), {}),
    ("Roll the Old Chariot Along", "pdf", os.path.join(PDF_DIR, "Roll the Old Chariot Along.pdf"), {}),
    ...
    ("Along the Navaho Trail", "pdf", os.path.join(PDF_DIR, "Along the Navajo Trail chart.pdf"), {}),
    ("Catfish John", "pdf", os.path.join(PDF_DIR, "Catfish John chart.pdf"), {}),
    ...
    ("Cumberland Gap", "abc", os.path.join(ABC_DIR, "Cumberland Gap (lyrics version).abc"), {}),
    ("Camp Meeting on the Fourth of July", "abc", os.path.join(ABC_DIR, "Camp Meeting on the Fourth of July-verified.abc"), {}),
    ("America the Beautiful", "pdf", os.path.join(PDF_DIR, "America the Beautiful.pdf"), {}),
    ...
    ("Uncle Pen", "odt", os.path.join(ODT_DIR, "Uncle Pen A.odt"), {}),
